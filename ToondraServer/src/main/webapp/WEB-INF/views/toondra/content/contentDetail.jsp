...
<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header page-header-ahope">작품 관리 > 컨텐츠 관리 > 컨텐츠 수정</h3>
			<h5 class="page-header page-header-desc-ahope">작품의 컨텐츠를 수정합니다.</h5>
		</div>
</div>
<div class="row">
	<div class="col-lg-9" >
		<form class="form-horizontal" id="content_form" name="content_form" action="${pageContext.request.contextPath}/admin/content/updateContent" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<label class="col-sm-3 control-label" style="font-size: x-small;text-align: left;">회차 등록시 화로 입력해주세요.<br>예) 1화, 2화 </label>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
		    	<label class="col-sm-2 control-label">회별 썸네일</label>
		    	...
		    	<div class="col-sm-4">
			    	...
			    	<label class="col-sm-12 control-label" style="font-size: x-small;text-align: left;padding-left: 3px;">회별 썸네일을 업로드 하지 않으면 자동 생성됩니다.</label>
		    	</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="width:430px">
					<div class="fl">
						...
						<label class="col-sm-10 control-label" style="font-size: x-small;text-align: left;padding-left: 3px;">가로사이즈 690 픽셀 이하이며, 세로 사이즈는 제한 없습니다.<br>총 용량은 20MB이하이며, 파일 1개의 용량제한은 2MB입니다.<br>파일 형태는 gif, jpg입니다.</label>
					</div>
