...
<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header page-header-ahope">작품 관리 > 작품 등록</h3>
			<h5 class="page-header page-header-desc-ahope">신규 작품을 등록합니다.</h5>
		</div>
</div>
<div class="row">
	<div class="col-lg-7" >
		<form class="form-horizontal" id="work_form" name="work_form" action="${pageContext.request.contextPath}/admin/work/insertWork" method="post" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" class="form-control" maxlength="30" name="work_name" id="work_name" >
				</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-7">
			    	<input type="text" class="form-control" maxlength="100" size="50" id="work_desc" name="work_desc">
				</div>
