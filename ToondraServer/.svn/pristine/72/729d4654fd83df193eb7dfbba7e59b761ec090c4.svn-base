			...
			<div class="form-group">
				...
				<div class="col-sm-6" style="width:430px">
					<div class="fl">
						...
						<label class="col-sm-10 control-label" style="font-size: x-small;text-align: left;padding-left: 3px;">
							가로사이즈 690 픽셀 이하이며, 세로 사이즈는 제한 없습니다.<br>
							총 용량은 20MB이하이며, 파일 1개의 용량제한은 2MB입니다.<br>
							파일 형태는 gif, jpg입니다.
						</label>
					</div>
