...
public class MemberService {
	...
	public Result updateMemberLogout(HashMap<String, Object> param) throws Exception {
		
		Result result = new Result();
		
		if(dao.updateMemberLogout((String)param.get("login_key")) != 1) {
			throw new LogicException("[Query] update fail","403");
		}
	...
	public Result updateMemberPwChange(HashMap<String, Object> param) throws Exception {
	...
	public Result memberPush(HashMap<String, Object> param) throws Exception {
